 $(document).ready(function() {
   ...
   var iconsDay = ["11d", "09d", "10d", "13d", "01d", "02d", "03d", "04d"];

   //backgrounds for day weather patterns
   var backgroundsDay = ["http://1.bp.blogspot.com/-BQCOWJL3J68/VCVpa56Q5JI/AAAAAAAAA4g/6BabE_tcDdE/s1600/giphy.gif", "http://ww3.hdnux.com/photos/24/73/11/5485166/3/628x471.jpg", "http://images3.alphacoders.com/892/89289.jpg", "http://i820.photobucket.com/albums/zz130/faulkev/Codepen/15%20-%20lXlRsHq_zpspcm5v3nu.gif", "http://i820.photobucket.com/albums/zz130/faulkev/Codepen/16%20-%20eqrFTSO_zps1goemtob.jpg", "http://i820.photobucket.com/albums/zz130/faulkev/Codepen/05%20-%20Ni0vHRh_zps8jfrojuv.jpg", "http://i820.photobucket.com/albums/zz130/faulkev/Codepen/05%20-%20Ni0vHRh_zps8jfrojuv.jpg", "http://i820.photobucket.com/albums/zz130/faulkev/Codepen/01%20-%20RSLMR4X_zps0rsxrasb.jpg"];

   //icons for night weather patterns
   var iconsNight = ["01n", "02n", "03n", "04n"]; 

   //night weather backgrounds
   var backgroundsNight = ["http://i820.photobucket.com/albums/zz130/faulkev/Codepen/04%20-%20RRJS0bL_zps0mqqiam6.jpg", "http://i820.photobucket.com/albums/zz130/faulkev/Codepen/07%20-%20IzugpDQ_zpsnrgwhk3s.jpg", "http://i820.photobucket.com/albums/zz130/faulkev/Codepen/02%20-%20HXahmSP_zpsi234od5t.jpg", "https://icarushasfallen.files.wordpress.com/2010/07/1536-1249272668qq7l.jpg"];

   //weather condition codes for "haze, smoke, fog"
   var condsAtmos = [701, 711, 741];
   
   
   //backgrounds for "haze, smoke, fog"
   var backgroundsAtmos = ["http://i820.photobucket.com/albums/zz130/faulkev/Codepen/c0263efef16dfd0153f576f791bb228c_zpsv5yc0j9k.jpg", "http://i820.photobucket.com/albums/zz130/faulkev/Codepen/IMG_1424_zpsszlfpurh.jpg", "http://netanimations.net/children-of-men-cinemagraph-art.gif"];
   ...
   if (navigator.geolocation) {
     ...
     navigator.geolocation.getCurrentPosition(function(position) {
       ...
       var apiKey = '881b5955fcd17cbec3fe94131e417545';

       //url for current weather
       var apiURL1 = 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + long + '&APPID=' + apiKey;
       
       //url for 5 day forecast
       var apiURL2 = 'http://api.openweathermap.org/data/2.5/forecast/daily?lat=' + lat + '&lon=' + long + '&cnt=' + days + '&APPID=' + apiKey;

       //get JSON data
       $.get(apiURL1, function(daily) {

         //get weather icon and assign appropriate background image
         var iconID = daily.weather[0].icon;
         var weatherID = daily.weather[0].id;

         if (iconsDay.indexOf(iconID) > -1) {
           var pos = iconsDay.indexOf(iconID);
           $('body').css('background-image', 'url(' + backgroundsDay[pos] + ')');
         } else if (iconsNight.indexOf(iconID) > -1) {
           var pos = iconsNight.indexOf(iconID);
           $('body').css('background-image', 'url(' + backgroundsNight[pos] + ')');
         } else if (condsAtmos.indexOf(weatherID) > -1) {
           var pos = condsAtmos.indexOf(weatherID);
         ...
         var temp = kelvinToFaren(daily.main.temp);
         ...
         var windSpeed = daily.wind.speed * 2.23693629;
         
         //wind direction in degrees
         var deg = daily.wind.deg;

         //array of possible wind directions
         var arr = ["N", "NNE", "NE", "ENE", "E", "ESE", "SE", "SSE", "S", "SSW", "SW", "WSW", "W", "WNW", "NW", "NNW", "N"]

         //convert degrees to direction
         var windDir = arr[Math.round(deg / 22.5)];

         //display wind speed and direction
         $("#wind").html("Wind: " + Math.round(windSpeed) + " mph " + windDir);

         //humidity
         var humidity = daily.main.humidity;
       ...
       $.get(apiURL2, function(tenDay) {
         ...
         var day1 = new Date(d.setDate(d.getDate() + 0))
         var day2 = new Date(d.setDate(d.getDate() + 1))
         var day3 = new Date(d.setDate(d.getDate() + 1))
         var day4 = new Date(d.setDate(d.getDate() + 1))
         var day5 = new Date(d.setDate(d.getDate() + 1))

         //put into array
         var dates = [day1, day2, day3, day4, day5];
